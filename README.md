...
* The transcriptions of all remaining clips have been manually checked and the mistakes corrected
 ...
 There are numerous tools abd libraries available to modify the properties of an audio-file which can be used in a bash- or python-script, for example ffmpeg, sox, librosa, ...
