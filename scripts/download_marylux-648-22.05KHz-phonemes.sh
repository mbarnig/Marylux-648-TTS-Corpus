...
echo $RUN_DIR
# download MARYLUX-648-phonemes dataset
wget https://github.com/mbarnig/Marylux-648-TTS-Corpus/releases/download/v1-test/MARYLUX-648-22.05KHz-phonemes.zip
# extract
unzip  MARYLUX-648-22.05KHz-phonemes.zip
...
rm MARYLUX-648-22.05KHz-phonemes.zip
